...
import org.cqc.etl.model.obj.pptest2.iface.ILocationPK;
...
@Embeddable
public class LocationPK implements Cloneable, Serializable,  ILocationPK {

	/** Serial Version UID. */
	private static final long serialVersionUID = -559033235L;
    ...
    */
    @Override
    public LocationPK clone() throws CloneNotSupportedException {
		
        final LocationPK copy = (LocationPK)super.clone();
	...
	public boolean equals(final Object aThat) {
		...
		final LocationPK that; 
		try {
			that = (LocationPK) proxyThat;
