...
/**
 * JudgementMethodId generated by hbm2java
 */
public class JudgementMethodId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof JudgementMethodId) ) return false;
		 JudgementMethodId castOther = ( JudgementMethodId ) other; 
 ...
 && ( (this.getMethodId()==castOther.getMethodId()) || ( this.getMethodId()!=null && castOther.getMethodId()!=null && this.getMethodId().equals(castOther.getMethodId()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getMethodId() == null ? 0 : this.getMethodId().hashCode() );
         return result;
   }   
