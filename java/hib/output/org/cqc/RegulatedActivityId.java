...
/**
*   Data access object representing a RegulatedActivityId.
*
*   @author matth
*   @version $Rev: 2 $
*/
public class RegulatedActivityId  implements java.io.Serializable
{
    //~~~~~~~~~~~~~~~~~~~~~~~~~~ FIELDS ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    */ 
    public RegulatedActivityId( String providerId, String locationId, String regulatedActivityId ) 
    {
    ...
    */
    ...
    public boolean equals( Object x ) 
    {
		...
		if ( !(x instanceof RegulatedActivityId) ) 
		    return false;
		    
		RegulatedActivityId other = (RegulatedActivityId) x; 
