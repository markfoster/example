...
import org.cqc.etl.model.obj.pptest2.iface.ILocationRegulatedActivityPK;
...
@Embeddable
public class LocationRegulatedActivityPK implements Cloneable, Serializable,  ILocationRegulatedActivityPK {

	/** Serial Version UID. */
	private static final long serialVersionUID = -559033229L;
	...
	*/
	...
	public Class<?> getClassType() {
		return LocationRegulatedActivityPK.class;
	}
    ...
    */
    @Override
    public LocationRegulatedActivityPK clone() throws CloneNotSupportedException {
		
        final LocationRegulatedActivityPK copy = (LocationRegulatedActivityPK)super.clone();
	...
	public boolean equals(final Object aThat) {
		...
		final LocationRegulatedActivityPK that; 
		try {
			that = (LocationRegulatedActivityPK) proxyThat;
