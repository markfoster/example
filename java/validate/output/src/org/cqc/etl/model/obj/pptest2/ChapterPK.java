...
import org.cqc.etl.model.obj.pptest2.iface.IChapterPK;
...
@Embeddable
public class ChapterPK implements Cloneable, Serializable,  IChapterPK {

	/** Serial Version UID. */
	private static final long serialVersionUID = -559033238L;

	

	/** Field mapping. */
	@Column( name = "chapter_number", nullable = false, length = 5  )
    ...
    */
    @Override
    public ChapterPK clone() throws CloneNotSupportedException {
		
        final ChapterPK copy = (ChapterPK)super.clone();

		copy.setChapterNumber(this.getChapterNumber());
	...
	public String toString() {
		...
		sb.append("chapterNumber: " + this.getChapterNumber() + ", ");
	...
	public boolean equals(final Object aThat) {
		...
		final ChapterPK that; 
		try {
			that = (ChapterPK) proxyThat;
		...
		boolean result = true;
		result = result && (((getChapterNumber() == null) && (that.getChapterNumber() == null)) || (getChapterNumber() != null && getChapterNumber().equals(that.getChapterNumber())));
	...
	public int hashCode() {
	int hash = 0;
		hash = hash + getChapterNumber().hashCode();
