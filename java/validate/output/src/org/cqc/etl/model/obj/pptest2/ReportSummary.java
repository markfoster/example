...
import org.cqc.etl.model.obj.pptest2.iface.IReportSummary;
...
@Entity
@Table(name = "report_summary", catalog = "pptest2")
public class ReportSummary implements Cloneable, Serializable, IPojoGenEntity, IReportSummary {
	 ...
	 * @param id to set
	 */
	public ReportSummary(ReportSummaryPK id) {
		this.id = id;
	}
	...
	*/
	 ...
	 */
	public void setId(final ReportSummaryPK id) {
		this.id = id;
	}
    ...
    */
    @Override
    public ReportSummary clone() throws CloneNotSupportedException {
		
        final ReportSummary copy = (ReportSummary)super.clone();
	...
	public boolean equals(final Object aThat) {
		...
		final ReportSummary that = (ReportSummary) aThat;
