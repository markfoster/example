...
import org.cqc.etl.model.obj.pptest2.iface.IRegisteredManagerConditionPK;
...
@Embeddable
public class RegisteredManagerConditionPK implements Cloneable, Serializable,  IRegisteredManagerConditionPK {

	/** Serial Version UID. */
	private static final long serialVersionUID = -559033207L;
	...
	*/
	...
	public Class<?> getClassType() {
		return RegisteredManagerConditionPK.class;
	}
    ...
    */
    @Override
    public RegisteredManagerConditionPK clone() throws CloneNotSupportedException {
		
        final RegisteredManagerConditionPK copy = (RegisteredManagerConditionPK)super.clone();
	...
	public boolean equals(final Object aThat) {
		...
		final RegisteredManagerConditionPK that; 
		try {
			that = (RegisteredManagerConditionPK) proxyThat;
